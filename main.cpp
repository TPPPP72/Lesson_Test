...
int main()
{
    ...
    interact_tester tester{"测试章节"};

    // 选择题样例
    MCQ q1{"Which of the following functions or classes can be used for printing (multiple choice)?",
...
int main()
{
    ...
    tester.run(test_type::practice); // 开始测试
}